                ...
                <div class="md:flex-1 px-4">
                    <div class="flex -mx-2 mb-4">
                        <div class="w-1/2 px-2">
                            <a href="{{route('home')}}"><button class="w-full bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700">Go back</button></a>
                        </div>
                    </div>
